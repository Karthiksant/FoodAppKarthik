...
const FoodCartDemo = () => {
  ...
  <div className="order-summary mt-4 mb-4 p-3 rounded" style={{ position: 'sticky', top: '20px', zIndex: 1, backgroundColor: '#ffbf00', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.4)', border: '1px solid #dee2e6' }}>
